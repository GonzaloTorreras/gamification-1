		...
		// skelJS (probably don't need to change anything here unless you know what you're doing)
			skelJS: {
				...
				breakpoints: {
					...
					'wide':	{ range: '961-1880', containers: 1400, grid: { gutters: 40 } },
					'normal':	{ range: '961-1620', containers: 1200, grid: { gutters: 40 } },
					'narrow':	{ range: '961-1320', containers: 'fluid', grid: { gutters: 30 , collapse: true } },
					'narrower':	{ range: '-960', containers: 'fluid', grid: { gutters: 30, collapse: true } },
